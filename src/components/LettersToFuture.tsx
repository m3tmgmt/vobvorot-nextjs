...
export default function LettersToFuture() {
  ...
  // Force English locale for date input
  useEffect(() => {
    if (dateInputRef.current) {
      ...
      // Add CSS to override browser locale
      ...
      if (!document.head.querySelector('#date-locale-override')) {
        style.id = 'date-locale-override';
        ...
        >
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <input
              ...
              data-locale="en-US"
              title="Select delivery date (MM/DD/YYYY format)"
