  ...
  try {
    ...
    return {
      ...
      images: product.images.map(img => ({
        ...
        order: 0,
        publicId: img.cloudinaryId || undefined
      })),
      skus: product.skus.map(sku => ({
        ...
        dimensions: sku.dimensions ? JSON.parse(sku.dimensions) : undefined,
      ...
      category: {
        ...
        image: product.category.imageUrl || undefined,
        order: product.category.sortOrder || undefined,
